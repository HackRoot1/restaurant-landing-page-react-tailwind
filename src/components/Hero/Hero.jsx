                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2">
                        ...
                        >
                            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold">
                                Welcome to the{" "}
                                <span className="text-yellow-600">Foodie</span>{" "}
                                Zone
                            </h1>
                            <p className="text-sm">
                                Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Nihil eum facere laborum
                                facilis fugit, accusantium voluptates.
                                Perferendis expedita nostrum explicabo.
                            </p>
                            <div>
                        ...
                        <div className="order-1 sm:order-2 min-h-[450px] sm:min-h-[450px] flex justify-center items-center relative">
                            ...
                            {/* Image list section */}
                            <div className="flex lg:flex-col lg:top-1/2 lg:-translate-y-1/2 lg:py-2 justify-center gap-2 absolute bottom-[0px] lg:-right-10 bg-black/30 dark:bg-white/30 rounded-full">
                                {ImageList.map((item) => (
                                    <img
                                        key={item.id}
                                        src={item.img}
